...
class Acc_salesType_model extends CI_Model
{
    ...
    {
        return $this->db->get_where('acc_sales_types',array('id'=>$id))->row_array();
    }
    ...
    function get_all_saleType()
    {
        ...
        return $this->db->get('acc_sales_types')->result_array();
    }
    ...
    {
        $this->db->where('id',$id);
        return $this->db->update('acc_sales_types',$params);
    }
    ...
    {
        return $this->db->delete('acc_sales_types',array('id'=>$id));
    }
}
