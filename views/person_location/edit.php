    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Person Location Edit</h3>
            </div>
			<?php echo form_open('person_location/edit/'.$person_location['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="person_id" class="form-control">
								...
								{
									$selected = ($person['person_id'] == $person_location['person_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="location_id" class="form-control">
								...
								{
									$selected = ($location['id'] == $person_location['location_id']) ? ' selected="selected"' : "";
