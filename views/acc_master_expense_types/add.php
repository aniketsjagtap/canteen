...
$(document).ready(function(){
	...
	var salesWrapper1 = $('.expenseType_wrapper');
	...
	var salesHTML1 = '<div><input type="text" maxlength="100"  name="expenseType[]" value="" id="expenseType" class="form-control"  required/></div>';
	var  amountHTML1= '<div><input type="text" maxlength="400"  name="expenseDescription[]" value="" id="expenseDescription" class="form-control"  /></div>';
    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Account Expense Types Add</h3>
            </div>
			
            <?php echo form_open('acc_master_expense_types/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group expenseType_wrapper">
							<div>
								<input type="text" maxlength="100"  name="expenseType[]" value="" id="expenseType" class="form-control"  required/>
							</div>
						</div>
					</div>
					<div class="col-md-6">
